...
namespace SadguruCRM.Helpers
{
    public static class Helper
    {
        ...
        public async static Task<List<Lead>> GenerateCustomerNameAndServicesShortCodes(IQueryable<Lead> leads) {
            ...
            using (SadguruCRMEntities db = new SadguruCRMEntities()) {
                ...
                foreach (var item in leads)
                {
                    ...
                    tasks.Add(Task.Run(() => (GenerrateSingleLeadCustomerNameAndServicesShortCodes(ref lead, ref services))));
                }
        ...
        public static Lead GenerrateSingleLeadCustomerNameAndServicesShortCodes(ref Lead item, ref List<Service> services)
        {
