...
namespace SadguruCRM.Models
{
    ...
    public partial class Customers_Consult_Person_Email_Mapping
    {
        public long Customers_Consult_Person_Email_Mapping_ID { get; set; }
        public long Customers_Consult_Person_Mapping_ID { get; set; }
        public string Consult_Person_Email { get; set; }
